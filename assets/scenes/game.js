...
export default class Game extends Phaser.Scene {
  ...
  init() {
    ...
    this.fruitRecolected = {
      ...
      [STRAW]: { count: 0, score: -50 },
    };
  }

  create() {
    //add background
    this.add.image(400, 300, "Fondo_Tarde").setScale(1.5);
    ...
    platforms.create(500, 450, "ground2").setScale(.55).refreshBody();

    let platforms2 = this.physics.add.staticGroup();
    platforms.create(250, 350, "ground2").setScale(.55).refreshBody();
